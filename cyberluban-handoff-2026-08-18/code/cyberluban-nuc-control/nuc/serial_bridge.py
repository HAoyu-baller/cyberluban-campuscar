...
class SerialBridge:
        ...
        while not self._stop.is_set():
            ...
            try:
                ...
                with serial.Serial(
                    ...
                    self._set_status(connected=False, device=device, error="ESP32 booting")
                    ...
                    connection.flush()
                    self._set_status(connected=True, device=device, error="")
                    self._record("Serial connected; emergency stop sent")
    ...
    def _mock_worker(self) -> None:
        self._set_status(connected=True, device="mock", error="")
